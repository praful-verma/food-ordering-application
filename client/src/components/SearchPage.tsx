...
//                             onChange={(e) => setSearchQuery(e.target.value)} />
//                         <Button className="bg-orange-400 hover:bg-orange-500">Search</Button>
...
//                             <div>
//                                 {
//                                     ["a", "b", "c"].map((selectedFilter: string, idx: number) => (
//                                         <div key={idx} className="relative inline-flex item-center max-w-full">
...
//                         <div className="grid md:grid-cols-3 gap-4">
//                             {[1,2,3].map((number:number ,idx:number) => (
//                             <Card
//                                 // key={restaurant._id}
//                                 className="bg-white dark:bg-gray-800 shadow-xl rounded-xl overflow-hidden hover:shadow-2xl transition-shadow duration-300"
//                             >
