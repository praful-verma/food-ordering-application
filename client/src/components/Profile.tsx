...
//     e.preventDefault();
//     setIsLoading(true);
//     setTimeout(() => setIsLoading(false), 1000); // UI-only fake submit
//   };
...
//           <div
//             onClick={() => imageRef.current?.click()}
//             className="absolute inset-0 flex items-center justify-center opacity-0 hover:opacity-100 transition bg-black/50 rounded-full cursor-pointer"
//           >
//             <Plus className="text-white w-8 h-8" />
//           </div>
//         </Avatar>
...
//           className="font-bold text-2xl border-none focus-visible:ring-0"
//         />
//       </div>
