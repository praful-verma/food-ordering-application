...
//     searchRestaurant : async (searchText:string , searchQuery:string , selectedQuisines:any) =>{
//         try {
//             set({loading:true}) ;
//             const params = new URLSearchParams() ;  
//             params.set("searchQuery" , searchQuery) ;
//             params.set("selectedQuisines" , selectedQuisines) ;
//             const response = await axios.get(`${API_END_POINT}/search/${searchText}?searchQuery`, ) 
