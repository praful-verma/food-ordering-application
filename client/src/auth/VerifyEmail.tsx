...
//     const submitHandler = async (e:FormEvent<HTMLFormElement>) =>{
//         e.preventDefault() ;
//         const verficationCode = otp.join("") ;
//         try {
...
//                     </div>
//                     {
//                         loading ? (<Button disabled className="bg-orange-400 hover:bg-orange-500 mt-6 w-full"><Loader2 className="mr-2 h-4 w-4 animate-spin">Loading</Loader2></Button>):(<Button className="bg-orange-400 hover:bg-orange-500 mt-6 w-full">verify</Button>) 
//                     }
